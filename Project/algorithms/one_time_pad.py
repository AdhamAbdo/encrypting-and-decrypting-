...
class OneTimePadUI:
    def __init__(self, master):
        ...
        # Encryption Button
        self.encrypt_button = ttk.Button(master, text="Encrypt", command=self.encrypt_text, width=10)
        self.encrypt_button.grid(row=8, column=0, pady=10, padx=(10, 5), sticky="ew")

        # Decryption Button
        self.decrypt_button = ttk.Button(master, text="Decrypt", command=self.decrypt_text, width=10)
        ...
        # Add empty columns for right padding
        self.empty_right_col_1 = ttk.Label(master, text="")
        self.empty_right_col_1.grid(row=0, column=3, padx=20)
        self.empty_right_col_2 = ttk.Label(master, text="")
        self.empty_right_col_2.grid(row=1, column=3, padx=20)
